...
ipcMain.handle('audio:process', async(_e,p={})=>{
  try{
    ...
    const sys=`Bạn là chuyên gia chuyển audio/kịch bản thành prompt tạo video. Đầu ra phải là JSON array các scene string. Mỗi scene đúng format: Scene 01 – Title | Character1: full description | Character2: full description | Style: ... | Character voices: ... | Camera: ... | Setting: ... | Mood: ... | Audio cues: ... | Dialog: ... | Subtitles: ... . Style JSON người dùng cung cấp phải được tôn trọng. Lời thoại: ${p.dialog?'có':'không'}. Phụ đề: ${p.subtitles?'có':'không'}. So sánh transcript với văn bản gốc nếu có, chỉnh transcript cho khớp nội dung gốc, rồi tạo prompt đúng nội dung văn bản gốc.`;
